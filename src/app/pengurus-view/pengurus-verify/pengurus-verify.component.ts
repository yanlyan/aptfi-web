...
@Component({
  selector: 'app-pengurus-verify',
  templateUrl: './pengurus-verify.component.html',
  styleUrls: ['./pengurus-verify.component.scss'],
})
export class PengurusVerifyComponent implements OnInit, AfterViewInit {
